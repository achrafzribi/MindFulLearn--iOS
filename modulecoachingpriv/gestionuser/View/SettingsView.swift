        ...
        NavigationView {
            Form {
                ...
                Section(header: Text("Account")) {
                    Button(action: {
                        Webservice().deleteUser { success in
                            if success {
                                // Handle success, e.g., show an alert, navigate to login screen, etc.
                                print("User deleted successfully")
                            } else {
                                // Handle failure, e.g., show an alert with an error message
        ...
        .overlay(
            VStack {
                ...
                HStack {
                    ...
                    Spacer()
                    NavigationLink(destination: MapfullView()) {
